 ...
 * @(#)SortDialog.java
 *
 * $Id: SortDialog.java,v 1.1 2001/11/15 23:21:00 oleglebedev Exp $
 *
...
public class SortDialog extends SharpDialog {
	...
	if (command.equals(ascending_1)) {
	    ascending1 = true;
	} else if (command.equals(descending_1)) {
	    ascending1 = false;
	    // Set the sort order of the scond column
	}

	if (command2.equals(ascending_2)) {
	    ascending2 = true;

	} else if (command2.equals(descending_2)) {
	    ascending2 = false;
	}
